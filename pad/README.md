...
5) Upon successful validation, an archive will be generated named libfrvt_pad_\<company\>_\<three-digit submission sequence\>.tar.gz
...
--recipient frvt@nist.gov --sign libfrvt_pad_<company>_<three-digit submission sequence>.tar.gz
````
